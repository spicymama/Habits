        ...
        ScrollView {
            ...
            VStack {
                ...
                Group {
                    ...
                    Category(category: self.$category, tap: self.$categoryTap, catArr: Home.shared.$categoryArr, dateTap: self.$catDateTap)
                    HStack {
                        Text("Notes")
                            .foregroundColor(.gray)
                            .font(.system(size: 35))
            ...
            .animation(.easeInOut(duration: 0.5), value: self.categoryTap)
            .padding(.top, 50)
